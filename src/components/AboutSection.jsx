        ...
        <div className='bg-primary text-light py-5' id='about'>
            <div className='container py-5'>
                <div className='flex-column-reverse flex-md-row row'>
                    <div className='col-md-6 mt-5 mt-md-0  d-flex flex-column align-items-md-start align-items-center'>
                       <img className='img-fluid w-75' src={AboutImg} alt="about img" />
                    </div>
                    <div className='col-md-6 d-flex flex-column justify-content-center'>
                        <h2 className='md-5 pb-4'>About Me</h2>
                        <p className='text-start fs-6 lh-base'>I am a Software Engineering graduate, frontend developer with good experience in building web development solutions.
                        ...
                        And also I have five years of freelance experience in graphic design, logo and illustration categories.
                        ...
                        <p className='text-start mb-5 fs-6 lh-base'>Beyond my technical skills, I am passionate about staying updated with the latest industry trends and
