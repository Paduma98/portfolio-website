           ...
           <div className='container py-md-5'>
            <div className='row'>
               <div className='col-md-6 d-flex flex-column align-items-start justify-content-center mt-5 mt-md-0'>
                  ...
                  <h3 className='text-capitalize text-start text-primary fs-3 mb-4'>font-end web developer</h3>
                  <p className='text-dark text-start fs-6 lh-base pb-4'>I am a Software Engineering graduate, frontend developer with good experience in building web development solutions. 
                  In addition, a person who is particularly interested in UI/UX designing. With over five years of freelance experience in Graphic 
